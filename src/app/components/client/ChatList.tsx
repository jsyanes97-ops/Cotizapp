...
export function ChatList({ onBack }: ChatListProps) {
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-hidden">
            <ProviderChat
              ...
              type={selectedChat.providerId ? 'Servicio' : 'Producto'}
  ...
  return (
    <>
        ...
        <Card className="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200">
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">
              Todos tus chats con proveedores en un solo lugar
            </p>
          </CardHeader>
        </Card>
      ...
      {/* Mobile View - Button to open drawer */}
      <div className="sm:hidden flex flex-col items-center justify-center h-full p-6 text-center">
        ...
        <h2 className="text-xl font-bold mb-2">Mis Chats</h2>
        <p className="text-gray-600 mb-6">
          {chats.length === 0
            ? 'No tienes conversaciones aún'
            : `Tienes ${chats.length} conversación${chats.length > 1 ? 'es' : ''}`
          }
        </p>
